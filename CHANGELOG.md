...
## [0.1.0](https://github.com/charleeislegend/stremthru/compare/v0.61.1...0.1.0) (2025-04-02)
...
* add support for uptream node ([f704542](https://github.com/charleeislegend/stremthru/commit/f70454298382413dfe7b04d92799eaf376173cd9))
...
* **buddy:** add auth token config ([f830911](https://github.com/charleeislegend/stremthru/commit/f8309119fb8a469662027961c413cb10a00bab1e))
* **buddy:** add local cache ([73b869e](https://github.com/charleeislegend/stremthru/commit/73b869ee810fd3547088794a4b500f55948ad755))
...
* **core:** improve cache initialization ([8c31e5b](https://github.com/charleeislegend/stremthru/commit/8c31e5bc5123fa4ecd9e74c68c49423abbde50e6))
* **core:** rename magnet invalid error ([0b6be1f](https://github.com/charleeislegend/stremthru/commit/0b6be1f7b0264c878da5ce0a7464eda999f460f1))
* **db:** add 'heavy' tag for auto schema migration ([0d6b28f](https://github.com/charleeislegend/stremthru/commit/0d6b28fd4cf98cb27e0fc1940a560e06c1f31b59))
...
* **db:** add support for postgresql ([df3473c](https://github.com/charleeislegend/stremthru/commit/df3473c461f9aae8a95d56a715befbfbd6461a6f))
* **db:** handle connection and transaction better ([3c60920](https://github.com/charleeislegend/stremthru/commit/3c609203f1953ac545549d562729c9c74c3688d6))
* **db:** initial setup ([7371667](https://github.com/charleeislegend/stremthru/commit/73716677b9a9301763a61e5f584da13f489e65f9))
* **db:** log magnet_cache insert failure better ([0624b1a](https://github.com/charleeislegend/stremthru/commit/0624b1a8460f83e48cd5c94bba79d112438159ee))
* **db:** switch from libsql to sqlite3 ([dc9e0c8](https://github.com/charleeislegend/stremthru/commit/dc9e0c86212ea1c050348415c9f04c1feab10c1d))
...
* **db:** use wal mode for sqlite ([39f2b18](https://github.com/charleeislegend/stremthru/commit/39f2b18e8c628c01a00d9c933d1b9ed16f8cdc5f))
...
* extract request stuffs ([031dd77](https://github.com/charleeislegend/stremthru/commit/031dd77a09db0370e4344d682f9cd53e4c86a4d3))
* improve errors ([dcbe689](https://github.com/charleeislegend/stremthru/commit/dcbe689d057a0b1714d4fb68b245f3dd8d3a9fa7))
...
* **kv:** add type field ([fc4ae55](https://github.com/charleeislegend/stremthru/commit/fc4ae55c34bbec48c441c837026551464e96f7fc))
...
* **magnet_cache:** extract and fix db stuffs ([8fbeafb](https://github.com/charleeislegend/stremthru/commit/8fbeafbb7c9a3099f203e1837d84adfbad9b0e2c))
* **magnet_cache:** get rid of unnecessary transaction ([fb7b244](https://github.com/charleeislegend/stremthru/commit/fb7b2441c1150d0499114183a891ffeabe1472c8))
...
* pass X-StremThru-Store-Name request header to response ([010f626](https://github.com/charleeislegend/stremthru/commit/010f62680aff744f41dddcb45c10325e5b7c41ac))
...
* **peer:** introduce concept of peer ([18ced66](https://github.com/charleeislegend/stremthru/commit/18ced66a55e6a72630767e8231eeeb783011212d))
...
* **sdk/js:** improve StremThruError ([f2488ee](https://github.com/charleeislegend/stremthru/commit/f2488eeb5e95d6e171d7dae735d6752448ab5421))
...
* store magnet cache info in db ([7b32556](https://github.com/charleeislegend/stremthru/commit/7b325560ac69f1a0e126df020feebccca8ca74c4))
...
* **store/premiumize:** improve magnet status detection ([81f1f2a](https://github.com/charleeislegend/stremthru/commit/81f1f2a07e220f605f1471d355b5d98a7ec41f14))
* **store/premiumize:** improve types ([6d92bd9](https://github.com/charleeislegend/stremthru/commit/6d92bd9c3d77381530f2ff02c6d63846a2586dfe))
* **store/realdebrid:** improve add magnet ([0e9a3ca](https://github.com/charleeislegend/stremthru/commit/0e9a3cab32d439e789fb99b54218530423570947))
* **store/realdebrid:** support passing client ip ([1265f1b](https://github.com/charleeislegend/stremthru/commit/1265f1bc8d1c897bfd27239d591f3793435eb751))
* **store/realdebrid:** update error codes ([8a49941](https://github.com/charleeislegend/stremthru/commit/8a499413edb220cfd32a124a2138797f1e7f28ad))
...
* **store:** add .hash for GetMagnet and ListMagnets ([aa93af5](https://github.com/charleeislegend/stremthru/commit/aa93af5f8fed38d2dd6ff8118e3d49893127cff6))
* **store:** add added_at field for magnet list/get ([d772158](https://github.com/charleeislegend/stremthru/commit/d772158053e4a519d43dc607125b4244afcc1ae0))
* **store:** add cache for torbox store ([dc2f26a](https://github.com/charleeislegend/stremthru/commit/dc2f26a8e8f3abec69504e8ea8a19b688688a0eb))
* **store:** add config for toggling tunnel ([b4ecc59](https://github.com/charleeislegend/stremthru/commit/b4ecc59cd95fbd990fed5fa14b66630bdd1fb5ad))
...
* **store:** add support for buddy ([5243279](https://github.com/charleeislegend/stremthru/commit/5243279eac80290843c2243223b5d3c9213afcb3))
...
* **store:** expose lowercase .hash for magnet ([709ec45](https://github.com/charleeislegend/stremthru/commit/709ec45a85892c2c8b98e2a9d8fce261f49ee1f6))
...
* **store:** initial realdebrid integration ([440cab2](https://github.com/charleeislegend/stremthru/commit/440cab237e5264df16b8655f2131f294a48cf5c0))
* **store:** initial torbox integration ([23d5cfd](https://github.com/charleeislegend/stremthru/commit/23d5cfdddb6dc06b58c56e2fff3ca4731914b60d))
* **store:** integrate buddy with all stores ([cd4998d](https://github.com/charleeislegend/stremthru/commit/cd4998d1543d72f17cdc14fca83082ea8216db0d))
* **store:** integrate upstream for check and track magnet cache ([f6bf4d7](https://github.com/charleeislegend/stremthru/commit/f6bf4d7900c58d61b238fb075c58725f5bd158bc))
...
* **store:** support pagination for list magnets ([0869539](https://github.com/charleeislegend/stremthru/commit/0869539a3ac4ac2e447af87658efc0612f05ec30))
...
* **store:** update error code for invalid store name ([281041e](https://github.com/charleeislegend/stremthru/commit/281041e978e2a6a66de37cc12b182df0b5ef9b4d))
* **store:** use local storage when buddy not available ([43fe0a3](https://github.com/charleeislegend/stremthru/commit/43fe0a308af600fd44df7a680ecafd5163c466f0))
...
* **stremio/sidekick:** support addons reset ([b8ba57b](https://github.com/charleeislegend/stremthru/commit/b8ba57ba0c0ee3f9e125e4092c99d89f9fd962bc))
...
* **stremio/wrap:** make track magnet cache non-blocking ([c5d0212](https://github.com/charleeislegend/stremthru/commit/c5d0212450e750fe8d98ea45ca2244461f502190))
...
* **stremio:** adjust proxied addon request headers ([9de9759](https://github.com/charleeislegend/stremthru/commit/9de97599c58397b29ed33e9752f948fd5f70e43e))
...
* support fallback store auth config ([8a6cbd8](https://github.com/charleeislegend/stremthru/commit/8a6cbd8a89844d6b8f77b92f38e8668c1b644cce))
* support redis cache ([3bfbe70](https://github.com/charleeislegend/stremthru/commit/3bfbe70a7dfe16f12cb6689d5772e63eece4da8f))
* update header for buddy token ([45afd6d](https://github.com/charleeislegend/stremthru/commit/45afd6dd4cf5df37fa2f4c248acf1ff0ffd598f6))
...
* **config:** handle env var with empty value ([7a1abcf](https://github.com/charleeislegend/stremthru/commit/7a1abcfee81d02fcf1c3128f4f2bb7733053f90e))
...
* **core:** handle empty body for 204 status ([21417f1](https://github.com/charleeislegend/stremthru/commit/21417f11107ea7f3a412e2829d2aa0eef49eada6))
* **core:** remove empty dn query in ParseMagnet ([2aa59ff](https://github.com/charleeislegend/stremthru/commit/2aa59ffbc2e381d06487f35f78768ebb237e9080))
...
* handle upstream service unavailable ([80d69ab](https://github.com/charleeislegend/stremthru/commit/80d69abc7266234c205eff726db300a0070e467d))
...
* **peer_token:** fix schema file for postgresql ([aad8e7b](https://github.com/charleeislegend/stremthru/commit/aad8e7b37d504feaa749353d1937420b8607393b))
...
* **store/alldebrid:** ensure non-null .files for GetMagnet ([784ee1f](https://github.com/charleeislegend/stremthru/commit/784ee1fa5eb637b782c296a7c6e01e69224e815f))
* **store/debridlink:** handle not found for GetMagnet ([5cb1fb7](https://github.com/charleeislegend/stremthru/commit/5cb1fb7f20876e897a0794b904327dfe131fd831))
* **store/debridlink:** pass query params for ListSeedboxTorrents ([8a10e26](https://github.com/charleeislegend/stremthru/commit/8a10e26519108b899ad65072af2b01687a0a21d9))
...
* **store/premiumize:** handle not found for GetMagnet ([77dc312](https://github.com/charleeislegend/stremthru/commit/77dc31288f3bf084af2197dde5ed61506eca6e2b))
* **store/premiumize:** handle not-premium error better ([494397b](https://github.com/charleeislegend/stremthru/commit/494397b1b4d420942139a60aa5e8f1a791d52919))
...
* **store/premiumize:** prefix file path with / ([a3eb584](https://github.com/charleeislegend/stremthru/commit/a3eb5844b78612d0f6beac25c8bf508924627545))
* **store/realdebrid:** deal with inconsistent type in response ([5f22bfb](https://github.com/charleeislegend/stremthru/commit/5f22bfb9d351619de0388a7c69bf58d4f3869b1a))
...
* **store/torbox:** error handling for get magnet ([e28e401](https://github.com/charleeislegend/stremthru/commit/e28e401263ea0113dc5787ffad228eb640c0d82a))
...
* **store/torbox:** handle 404 for list torrents ([9730b8a](https://github.com/charleeislegend/stremthru/commit/9730b8a52bcba39a6c42180c2f2ce8f900b83441))
* **store/torbox:** handle extra item for list torrents ([a43167d](https://github.com/charleeislegend/stremthru/commit/a43167d10b12046e452b6a879d92318839e16b4b))
...
* **store:** nil-error for buddy ([1d597ab](https://github.com/charleeislegend/stremthru/commit/1d597ab7d4e2f440fe966e09b824c00c89bfd613))
* **store:** pass client ip only for non-proxy-authorized requests ([7f89bc3](https://github.com/charleeislegend/stremthru/commit/7f89bc3dd889100529e71b29b675f395c4fa7668))
* **store:** store name in error ([fee51a2](https://github.com/charleeislegend/stremthru/commit/fee51a26dcab67cd3cfd0ca5791906c2de3c3167))
...
* **stremio/store:** handle empty metas ([2c91c21](https://github.com/charleeislegend/stremthru/commit/2c91c2164fc1e21cdd30a54968bdf334a0da0a45))
...
* **stremio/wrap:** return blank manifest without config ([222c07c](https://github.com/charleeislegend/stremthru/commit/222c07cf104dd275a763ed0c1dfab7ff0a4aaff2))
...
* update type to fix unexported field issue ([de5f5ba](https://github.com/charleeislegend/stremthru/commit/de5f5ba07be4aee6f24aa7917c6e7bca298d63b8))
...
* **store:** cache access link token verification ([0db97d2](https://github.com/charleeislegend/stremthru/commit/0db97d2f8c235ce1f57ffa68e4db509bf645e0ef))
...
* add release job ([d6bdd2e](https://github.com/charleeislegend/stremthru/commit/d6bdd2ea57153ae03483cb8bc6639ea04bd913cc))
